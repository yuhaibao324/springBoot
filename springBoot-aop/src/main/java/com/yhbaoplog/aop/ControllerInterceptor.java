...
import com.yhbaoplog.annotation.Permission;
...
public class ControllerInterceptor {
	 ...
	 */
	// @Pointcut("execution(public * com.yhbaoplog.web.controller..*(..)) and
	// @annotation(org.springframework.web.bind.annotation.RequestMapping)")
	@Pointcut("execution(public * com.yhbaoplog.web..*.*(..))")
